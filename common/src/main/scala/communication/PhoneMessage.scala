...
object PhoneMessage {
  ...
  case class UploadedPictureFor(computerId: String, movieId: Movie.Id, requestId: Long) extends PhoneToServerMessage
  ...
  case class ComputerAskedPicture(computerId: String, movieId: Movie.Id, requestId: Long) extends ServerToPhoneMessage
